...
create index idx_seasons_workspace         on public.seasons (workspace_id);
create index idx_collections_workspace     on public.collections (workspace_id);
create index idx_collections_brand         on public.collections (brand_id);
...
create index idx_product_sections_product  on public.product_sections (product_id);
create index idx_product_sections_key      on public.product_sections (section_key);
